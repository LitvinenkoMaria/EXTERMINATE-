...
class Tardis:
    ...
    def draw(self, scale_tardis):
        ...
        rect(self.screen, BLACK, (self.x + round(7 * k), self.y - round(9 * k), round(35 * k), round(10 * k)),
             round(2 * k))

        rect(self.screen, GREY, (self.x + round(10 * k), self.y + round(25 * k), round(10 * k), round(10 * k)))
        rect(self.screen, BLACK, (self.x + round(10 * k), self.y + round(25 * k), round(10 * k), round(10 * k)),
             round(2 * k))

        rect(self.screen, GREY, (self.x + round(30 * k), self.y + round(25 * k), round(10 * k), round(10 * k)))
        rect(self.screen, BLACK, (self.x + round(30 * k), self.y + round(25 * k), round(10 * k), round(10 * k)),
             round(2 * k))

        rect(self.screen, BLUE, (self.x - round(5 * k), self.y + round(85 * k), round(60 * k), round(10 * k)))
        rect(self.screen, BLACK, (self.x - round(5 * k), self.y + round(85 * k), round(60 * k), round(10 * k)),
             round(2 * k))

        rect(self.screen, BLACK, (self.x + round(30 * k), self.y + round(40 * k), round(10 * k), round(10 * k)),
             round(2 * k))

        rect(self.screen, BLACK, (self.x + round(10 * k), self.y + round(40 * k), round(10 * k), round(10 * k)),
             round(2 * k))

        rect(self.screen, BLACK, (self.x + round(30 * k), self.y + round(55 * k), round(10 * k), round(10 * k)),
             round(2 * k))

        rect(self.screen, BLACK, (self.x + round(10 * k), self.y + round(55 * k), round(10 * k), round(10 * k)),
             round(2 * k))

        rect(self.screen, BLACK, (self.x + round(30 * k), self.y + round(70 * k), round(10 * k), round(10 * k)),
             round(2 * k))

        rect(self.screen, BLACK, (self.x + round(10 * k), self.y + round(70 * k), round(10 * k), round(10 * k)),
             round(2 * k))

        rect(self.screen, BLACK, (self.x + round(5 * k), self.y + round(20 * k), round(40 * k), round(65 * k)),
             round(2 * k))
        ...
        rect(self.screen, BLACK, (self.x + round(22 * k), self.y - round(13 * k), round(5 * k), round(5 * k)),
             round(1 * k))
